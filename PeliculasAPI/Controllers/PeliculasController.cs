        ...
        public async Task<ActionResult> Post([FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    pelicula.Poster = await almacenadorArchivos.EditarArchivo(contenido, extension, contenedor, ruta: pelicula.Poster, peliculaCreacionDTO.Poster.ContentType);
                }
            }
        ...
        public async Task<ActionResult> Put(int id, [FromForm] PeliculaCreacionDTO peliculaCreacionDTO)
        {
            ...
            if (peliculaCreacionDTO.Poster != null)
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    var contenido = memoryStream.ToArray();
                    var extension = Path.GetExtension(peliculaCreacionDTO.Poster.FileName);
                    peliculaDB.Poster = await almacenadorArchivos.EditarArchivo(contenido, extension, contenedor, ruta: peliculaDB.Poster, peliculaCreacionDTO.Poster.ContentType);
                }
            }
