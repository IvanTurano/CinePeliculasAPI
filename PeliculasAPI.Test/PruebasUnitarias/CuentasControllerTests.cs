...
namespace PeliculasAPI.Test.PruebasUnitarias
{
    ...
    public class CuentasControllerTests: BasePruebas
    {
        ...
        private async Task CrearUsuarioHelper(string nombreBD)
        {
            ...
            var userInfo = new UserInfo() { Email = "ejemplo@gmail.com", Password = "Aa123456!" };
        ...
        public async Task UsuarioNoPuedeLogearse()
        {
            ...
            var userInfo = new UserInfo() { Email = "ejemplo@gmail.com", Password = "malaPassword" };
        ...
        private CuentasController ConstruirCuentasController(string nombreBD)
        {
            ...
            {
                {"JWT:key", "ASDASDASDASDASDETRYHRTUJTYIKGHGNBDFVSERG" }
            };
