...
namespace PeliculasAPI.Test.PruebasUnitarias
{
    ...
    public class ReviewsControllerTests: BasePruebas
    {
        ...
        public async Task UsuarioNoPuedeCrearDosReviewsParaLaMismaPelicula()
        {
            ...
            var peliculaId = contexto.Peliculas.Select(x => x.Id).FirstOrDefault();
            var review1 = new Review() { PeliculaId = peliculaId, UsuarioId = usuarioPorDefectoId, Puntuacion = 5, Comentario = "aasd" };
            ...
            controller.ControllerContext = ConstuirControllerContext();
        ...
        public async Task CrearReview()
        {
            ...
            var reviewCreacionDTO = new ReviewCreacionDTO() { Puntuacion = 5, Comentario = "buena peli" };
            var respuesta = await controller.Post(peliculaId, reviewCreacionDTO);
